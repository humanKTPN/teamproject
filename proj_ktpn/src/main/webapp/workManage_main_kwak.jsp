	...
	<div class="menu-con work">
		<div>
			<div id="title-name">
				...
				<div class="icon-sub">
					관리자님 환영합니다. <i
						class="fas fa-regular fa-arrow-right-from-bracket fa-md"> <span
						...
						<div class="dropBox">
							<form method="post" action="CNTRL_PR_Kwak">
								<select name="cate" id="cate">
									...
									<option value="호기">작업일자</option>
									<%
									String sch = "";
									  if(request.getParameter("search_desc")==null) sch ="";
									  else sch = request.getParameter("search_desc");
									%>
								</select> <input type="text" class="select" name="search_desc" value="<%= sch %>"> 
						...
						<div class="command-loc">
							<div class="command-div">
								<table class="command-table">
									...
									<%
									DAO_PR_Kwak dao1 = new DAO_PR_Kwak();
									List<DTO_PR_Kwak_main> dto1 = dao1.listData();
									...
									if ("ss".equals(s)) {
										...
										dto.setStr_dt(request.getParameter("str_dt").replace("-","")); 
										dto.setEnd_dt(request.getParameter("end_dt").replace("-",""));
									...
									<tr>
										<td class="command-td"><a
											href="workManage_select_kwak.jsp?prod_cd=<%=dt.getPROD_CD()%>"><%=dt.getPROD_CD()%></a></td>
