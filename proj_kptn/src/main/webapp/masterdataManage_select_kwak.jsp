...
<!--                                     <td class="detail-td"><span >1</span></td> -->
                                    ...
                                    <td class="detail-td"><span class="spn-td"><%=dt.getMT_MNG_NM() %></span><input type='text' class="mod-td hide" value="염화비닐"></td>
                        ...
                        <div class="bompro-con">
                            <div class="bom-con">
                                <h4>항목명 :<span class="spn-td"> <%=dt.getMT_MNG_NM() %></span><input type='text' class="mod-td hide" value="염화비닐"></h4>
                                <table>
                                    <tr>
                                       <td>
                                       </td> 
                        ...
                        <div class="add-con">
                            ...
                            <form method="post" action="masterDataManagement_kwak_cotroller">
                                ...
                                <input type="hidden" value="<%=dt.getMT_MNG_CD() %>" name="MT_MNG_CD">
                                <input type="hidden" value="<%=dt.getMT_MNG_NM() %>" name="MT_MNG_NM">
                                <input type="hidden" value="<%=dt.getMT_MNG_DESC() %>" name="MT_MNG_DESC">
                             </form>
                            </div>
                        </div> 
                    </div>
