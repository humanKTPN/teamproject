                        ...
                        <div class="command-loc">
                            <div class="command-div">
                                <table class="command-table">
                                    <tr>
                                        <th class="command-th" scope = "col">항목명</th>
                                        <th class="command-th" scope = "col">항목코드</th>
                                        <th class="command-th" scope = "col">품목유형</th>
                                        <th class="command-th" scope = "col">단위값</th>
                                        <th class="command-th" scope = "col">거래처명</th>		
                           		...
                           		<form method="post" action="masterDataManagement_kwak_cotroller">
                                    <tr>
                                        ...
                                        <td class="command-td"><input type="text" name="MT_MNG_CD"></td>
                                        <td class="command-td"><input type="text" name="ITEM_TP"></td>
                                        <td class="command-td"><input type="text" name="MT_UNT_VAL"></td>
                                        <td class="command-td"><input type="text" name="CSTMR_NM"></td>
...
<!--                                     <div class="add"> -->
                                        ...
                                        <input class="add" type="submit" value="추가"/>
<!--                                     </div>                                 -->
                                </form>
                                </div> 
                            </div>
