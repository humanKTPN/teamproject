...
<!--                          <img class="eraser-img" src="https://cdn.011st.com/11dims/resize/1000x1000/quality/75/11src/product/6297562089/B.jpg?506000000"> -->
                            <table class="detail-table">
                                ...
                                <tr>
                                    <td class="detail-td"><span class="spn-td"><input type="text" value="<%=dt.getRT_CD()%>" name="rt_cd" disabled></span></td>
                                    <td class="detail-td"><span class="spn-td"><input type="text" value="<%=dt.getRT_NM() %>" name="rt_nm" ></span></td>
                        ...
                        <div class="bompro-con">
                            <div class="bom-con">
                                <h4>공정코드 :<span class="spn-td"><input type="text" value="<%=dt.getRT_CD()%>" name="rt_cd" disabled></span></h4>
